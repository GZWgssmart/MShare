...
CREATE TABLE `t_basic_setting` (
  ...
  `slider_img4` varchar(500) DEFAULT NULL COMMENT '轮播图4',
  `slider_img5` varchar(500) DEFAULT NULL COMMENT '轮播图5',
  `reg_bonus` double DEFAULT NULL COMMENT '注册资产奖励',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
...
INSERT INTO `t_basic_setting` VALUES (1,20,80,20,'','','','','',100,'2018-05-09 09:17:24',NULL);
...
--
-- Table structure for table `t_total_score`
--
...
CREATE TABLE `t_total_score` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `user_id` bigint(20) DEFAULT NULL COMMENT '用户编号',
  `total` bigint(20) DEFAULT NULL COMMENT '兑换数额',
  `score` bigint(20) DEFAULT NULL COMMENT '兑换积分',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `t_total_score`
--

INSERT INTO `t_total_score` VALUES (1,100000,100,800,'2018-05-19 21:26:59',NULL),(2,100000,200,1600,'2018-05-19 21:42:56',NULL);
...
CREATE TABLE `t_user` (
  ...
  `props` double DEFAULT '0' COMMENT '资产',
...
INSERT INTO `t_user` VALUES (100000,NULL,'13888888888',NULL,'4QrcOUm6Wau+VuBX8g+IPg==','4QrcOUm6Wau+VuBX8g+IPg==',NULL,'Test',NULL,4500,4948,'A',200,'10',NULL,NULL,NULL,NULL,NULL,'2017-12-11 19:13:08',NULL,0),(100001,NULL,'18888888888',NULL,'4QrcOUm6Wau+VuBX8g+IPg==',NULL,NULL,'测试',NULL,2180,210,NULL,0,NULL,NULL,0,NULL,NULL,100000,'2018-05-09 09:11:17',NULL,0),(100002,NULL,'13666666666',NULL,'4QrcOUm6Wau+VuBX8g+IPg==',NULL,NULL,'小米',NULL,8,2,NULL,0,NULL,NULL,0,NULL,NULL,100000,'2018-05-09 12:50:21',NULL,0),(100003,NULL,'15555555555',NULL,'4QrcOUm6Wau+VuBX8g+IPg==',NULL,NULL,'AA',NULL,0,0,NULL,0,NULL,NULL,0,NULL,NULL,100000,'2018-05-10 20:57:38',NULL,0),(100004,NULL,'18888889999',NULL,'4QrcOUm6Wau+VuBX8g+IPg==',NULL,NULL,NULL,NULL,0,0,NULL,0,NULL,NULL,0,NULL,NULL,NULL,'2018-05-17 14:27:56',NULL,0),(100007,NULL,'15770715607',NULL,'4QrcOUm6Wau+VuBX8g+IPg==',NULL,NULL,NULL,NULL,0,0,NULL,100,NULL,NULL,0,NULL,NULL,100000,'2018-05-18 16:52:18',NULL,0),(100009,NULL,'13672297775',NULL,'4QrcOUm6Wau+VuBX8g+IPg==',NULL,NULL,NULL,NULL,0,0,NULL,100,NULL,NULL,0,NULL,NULL,NULL,'2018-05-19 14:22:42',NULL,0);
