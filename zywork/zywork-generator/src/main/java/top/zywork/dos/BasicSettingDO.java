...
public class BasicSettingDO extends BaseDO {
    ...
    private static final long serialVersionUID = -9223372035929030270L;
    ...
    public BasicSettingDO (Long id, Double feePercent, Double moneyPercent, Double scorePercent, Date createTime, Date updateTime) {
        this.id = id;
