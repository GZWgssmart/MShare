 ...
 * @version 1.0
 */
public class UserSuggestDO extends BaseDO {

    private static final long serialVersionUID = -9223372036784500189L;
    ...
    public UserSuggestDO () {}

    public UserSuggestDO (Long suggestId, Long suggestUserId, String suggestSuggest, Date suggestCreateTime, Date suggestUpdateTime, Long userId, String userPhone, String userNickname, String userHeadicon) {
