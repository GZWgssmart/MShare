 ...
 * @version 1.0
 */
public class UserTransinDO extends BaseDO {

    private static final long serialVersionUID = -9223372035950928646L;
    ...
    public UserTransinDO () {}

    public UserTransinDO (Long transId, Long transTransFrom, Long transTransTo, Long transTotal, Date transTransTime, Date transCreateTime, String transUpdateTime, Long userId, String userPhone, String userNickname, String userHeadicon) {
