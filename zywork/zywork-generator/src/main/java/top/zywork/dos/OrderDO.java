...
public class OrderDO extends BaseDO {
    ...
    private static final long serialVersionUID = -9223372036817975256L;
    ...
    public OrderDO (Long id, String orderNo, Long total, Integer type, Long sellId, Long buyId, Date createTime, Date updateTime, Integer status, Date sellConfirmTime, Date buyConfirmTime, Date dealTime) {
        this.id = id;
