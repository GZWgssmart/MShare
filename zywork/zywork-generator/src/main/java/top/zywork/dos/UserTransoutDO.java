 ...
 * @version 1.0
 */
public class UserTransoutDO extends BaseDO {

    private static final long serialVersionUID = -9223372035381359376L;
    ...
    public UserTransoutDO () {}

    public UserTransoutDO (Long transId, Long transTransFrom, Long transTransTo, Long transTotal, Date transTransTime, Date transCreateTime, String transUpdateTime, Long userId, String userPhone, String userNickname, String userHeadicon) {
