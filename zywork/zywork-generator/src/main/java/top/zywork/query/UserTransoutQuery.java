 ...
 * @version 1.0
 */
public class UserTransoutQuery extends BaseQuery {

    private static final long serialVersionUID = -9223372035452310108L;
    ...
    public UserTransoutQuery () {}

    public UserTransoutQuery (Long transId, Long transTransFrom, Long transTransTo, Long transTotal, Date transTransTime, Date transTransTimeStart, Date transTransTimeEnd, Date transCreateTime, Date transCreateTimeStart, Date transCreateTimeEnd, String transUpdateTime, Long userId, String userPhone, String userNickname, String userHeadicon) {
