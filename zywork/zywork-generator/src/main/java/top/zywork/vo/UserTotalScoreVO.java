 ...
 * @version 1.0
 */
public class UserTotalScoreVO extends BaseVO {

    private static final long serialVersionUID = -9223372036454176043L;
    ...
    public UserTotalScoreVO() {}

    public UserTotalScoreVO(Long totalScoreId, Long totalScoreUserId, Long totalScoreTotal, Long totalScoreScore, Date totalScoreCreateTime, Date totalScoreUpdateTime, Long userId, String userPhone, String userNickname, String userHeadicon) {
