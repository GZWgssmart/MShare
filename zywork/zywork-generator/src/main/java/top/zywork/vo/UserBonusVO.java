 ...
 * @version 1.0
 */
public class UserBonusVO extends BaseVO {

    private static final long serialVersionUID = -9223372034883997764L;
    ...
    public UserBonusVO (Long bonusAccountsId, Long bonusAccountsUid, String bonusAccountsBonusName, Long bonusAccountsTotal, Date bonusAccountsUpdatedDate, Long userId, String userPhone, String userNickname, String userHeadicon) {
