...
public class OrderDTO extends BaseDTO {
    ...
    private static final long serialVersionUID = -9223372034792223162L;
    ...
    public OrderDTO (Long id, String orderNo, Long total, Integer type, Long sellId, Long buyId, Date createTime, Date updateTime, Integer status, Date sellConfirmTime, Date buyConfirmTime, Date dealTime) {
        this.id = id;
