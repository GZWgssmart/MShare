 ...
 * @version 1.0
 */
public class UserTransinDTO extends BaseDTO {

    private static final long serialVersionUID = -9223372036436398685L;
    ...
    public UserTransinDTO () {}

    public UserTransinDTO (Long transId, Long transTransFrom, Long transTransTo, Long transTotal, Date transTransTime, Date transCreateTime, String transUpdateTime, Long userId, String userPhone, String userNickname, String userHeadicon) {
