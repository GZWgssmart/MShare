 ...
 * @version 1.0
 */
public class UserTotalScoreDTO extends BaseDTO {

    private static final long serialVersionUID = -9223372035163936748L;
    ...
    public UserTotalScoreDTO() {}

    public UserTotalScoreDTO(Long totalScoreId, Long totalScoreUserId, Long totalScoreTotal, Long totalScoreScore, Date totalScoreCreateTime, Date totalScoreUpdateTime, Long userId, String userPhone, String userNickname, String userHeadicon) {
