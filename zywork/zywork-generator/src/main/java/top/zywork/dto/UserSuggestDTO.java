 ...
 * @version 1.0
 */
public class UserSuggestDTO extends BaseDTO {

    private static final long serialVersionUID = -9223372036034246074L;
    ...
    public UserSuggestDTO (Long suggestId, Long suggestUserId, String suggestSuggest, Date suggestCreateTime, Date suggestUpdateTime, Long userId, String userPhone, String userNickname, String userHeadicon) {
