...
window.operateEvents = {
    'click .to-detail': function (e, value, row, index) {
        showRemoteDetailModal('detail-modal', '/module/detail-modal', row, fieldTitles);
    },
    'click .to-edit': function (e, value, row, index) {
        showRemoteEditModal('edit-modal', '/module/edit-modal', 'edit-form', row, validateFields());
    },
    'click .to-inactive': function (e, value, row, index) {
        active('/module/active', row.id, 1, 'data-list', '/module/pager-cond');
    },
    'click .to-active': function (e, value, row, index) {
        active('/module/active', row.id, 0, 'data-list', '/module/pager-cond');
    },
    'click .to-remove': function (e, value, row, index) {
        remove('/module/remove/' + row.id, 'data-list', '/module/pager-cond');
    }
};
