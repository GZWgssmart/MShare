...
function loadTable() {
    ...
    $('#data-list').bootstrapTable({
        url: contextPath + '/user-buy/pager-cond',
        dataType: 'json',
        method: 'post',
...
window.operateEvents = {
    'click .to-detail': function (e, value, row, index) {
        showRemoteDetailModal('detail-modal', '/user-buy/detail-modal', row, fieldTitles);
    },
    'click .to-edit': function (e, value, row, index) {
        showRemoteEditModal('edit-modal', '/user-buy/edit-modal', 'edit-form', row, validateFields());
    },
    'click .to-inactive': function (e, value, row, index) {
        active('/user-buy/active', row.orderId, 1, 'data-list', '/user-buy/pager-cond');
    },
    'click .to-active': function (e, value, row, index) {
        active('/user-buy/active', row.orderId, 0, 'data-list', '/user-buy/pager-cond');
    },
    'click .to-remove': function (e, value, row, index) {
        remove('/user-buy/remove/' + row.orderId, 'data-list', '/user-buy/pager-cond');
    }
};
