...
<div class="modal-body">
    ...
    <span class="col-sm-8" id="bonusAccountsIdDetail"></span>
</div>

<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">用户编号：</span>
    <span class="col-sm-8" id="bonusAccountsUidDetail"></span>
</div>

<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">奖励名称：</span>
    <span class="col-sm-8" id="bonusAccountsBonusNameDetail"></span>
</div>

<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">奖励额：</span>
    <span class="col-sm-8" id="bonusAccountsTotalDetail"></span>
</div>

<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">更新时间：</span>
    <span class="col-sm-8" id="bonusAccountsUpdatedDateDetail"></span>
</div>
