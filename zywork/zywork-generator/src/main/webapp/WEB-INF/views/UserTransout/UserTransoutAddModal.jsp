...
<div class="modal-footer">
    ...
    <button id="btn-save" type="button" class="btn btn-primary" onclick="saveOrEdit('btn-save', 'add-modal', 'add-form', '/user-transout/save', 'data-list', '/user-transout/pager-cond')">确认</button>
</div>
