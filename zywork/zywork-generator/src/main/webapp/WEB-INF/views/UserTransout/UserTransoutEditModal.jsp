...
<div class="modal-footer">
    ...
    <button id="btn-edit" type="button" class="btn btn-primary" onclick="saveOrEdit('btn-edit', 'edit-modal', 'edit-form', '/user-transout/update', 'data-list', '/user-transout/pager-cond')">确认</button>
</div>
