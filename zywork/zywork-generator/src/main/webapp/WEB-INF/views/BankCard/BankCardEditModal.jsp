...
<div class="modal-footer">
    ...
    <button id="btn-edit" type="button" class="btn btn-primary" onclick="saveOrEdit('btn-edit', 'edit-modal', 'edit-form', '/bank-card/update', 'data-list', '/bank-card/pager-cond')">确认</button>
</div>
