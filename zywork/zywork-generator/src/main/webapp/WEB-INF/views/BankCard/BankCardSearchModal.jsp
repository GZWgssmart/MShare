...
<div class="modal-body">
    <table id="bank-card-data-list" data-classes="table table-hover text-nowrap" data-toolbar="#bank-card-toolbar"></table>

    <div id="bank-card-toolbar">
        <button class="btn btn-primary" onclick="">
            <i class="fa fa-key"></i>
            确认
        </button>
        <button class="btn btn-primary" onclick="showSearchForm('bank-card-search-form')">
            <i class="fa fa-eye"></i>
            高级搜索
        </button>
        <button type="button" class="btn btn-white" data-dismiss="modal">取消</button>

        <form id="bank-card-search-form" class="row form-horizontal search-form" style="display: none;">
            <div class="col-sm-6 form-group">
    <label for="bankNameSearch" class="col-sm-4 control-label">银行：</label>
    <div class="col-sm-8">
        <input id="bankNameSearch" name="bankName" class="form-control" placeholder="请输入银行">
    </div>
</div>

<div class="col-sm-6 form-group">
    <label for="cardNoSearch" class="col-sm-4 control-label">银行卡号：</label>
    <div class="col-sm-8">
        <input id="cardNoSearch" name="cardNo" class="form-control" placeholder="请输入银行卡号">
    </div>
</div>
    ...
    <div class="input-group date form_datetime col-sm-8" style="padding-left: 15px; padding-right: 15px;">
        ...
        <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
            ...
            <div class="col-sm-6 form-group text-right" style="padding-right: 30px;">
                <button type="button" class="btn btn-primary" onclick="doSearch('bank-card-data-list')">
                    <i class="fa fa-search"></i>
                    搜索
                </button>
                <button type="button" class="btn btn-primary" onclick="doSearchAll('bank-card-data-list', 'bank-card-search-form')">
                    <i class="fa fa-search"></i>
                    搜索所有
                </button>
                <button type="button" class="btn btn-primary" onclick="hideSearchForm('bank-card-data-list', 'bank-card-search-form')">
