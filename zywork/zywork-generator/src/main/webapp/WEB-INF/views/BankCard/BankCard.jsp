...
<div class="row wrapper wrapper-content animated fadeInRight">
    <div class="col-sm-12">
        ...
        <div id="toolbar">
            <button class="btn btn-primary" onclick="showRemoteAddModal('add-modal', '/bank-card/add-modal', 'add-form', validateFields())">
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu">
                <li>
                    <a href="javascript:void(0);" onclick="batchActive('/bank-card/batch-active', 0, 'data-list', '/bank-card/pager-cond', 'id')">
                        <i class="fa fa-check-square-o text-success"></i><span class="text-success">&nbsp;批量激活</span>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0);" onclick="batchActive('/bank-card/batch-active', 1, 'data-list', '/bank-card/pager-cond', 'id')">
                        <i class="fa fa-minus-square-o text-danger"></i><span class="text-danger">&nbsp;批量冻结</span>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0);" onclick="batchRemove('/bank-card/batch-remove', 'data-list', '/bank-card/pager-cond', 'id')">
...
<script src="<%=path%>/static/js/BankCard/BankCard.js"></script>
</html>
