...
<div class="row wrapper wrapper-content animated fadeInRight">
    <div class="col-sm-12">
        ...
        <div id="toolbar">
            <button class="btn btn-primary" onclick="showRemoteAddModal('add-modal', '/suggest/add-modal', 'add-form', validateFields())">
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu">
                <li>
                    <a href="javascript:void(0);" onclick="batchActive('/suggest/batch-active', 0, 'data-list', '/suggest/pager-cond', 'id')">
                        <i class="fa fa-check-square-o text-success"></i><span class="text-success">&nbsp;批量激活</span>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0);" onclick="batchActive('/suggest/batch-active', 1, 'data-list', '/suggest/pager-cond', 'id')">
                        <i class="fa fa-minus-square-o text-danger"></i><span class="text-danger">&nbsp;批量冻结</span>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0);" onclick="batchRemove('/suggest/batch-remove', 'data-list', '/suggest/pager-cond', 'id')">
...
<div class="col-sm-6 form-group">
    <label for="suggestSearch" class="col-sm-4 control-label">投诉建议：</label>
    <div class="col-sm-8">
        <input id="suggestSearch" name="suggest" class="form-control" placeholder="请输入投诉建议">
    </div>
</div>
...
<script src="<%=path%>/static/js/Suggest/Suggest.js"></script>
</html>
