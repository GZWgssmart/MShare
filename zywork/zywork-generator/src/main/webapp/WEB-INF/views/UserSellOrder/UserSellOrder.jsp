...
<div class="row wrapper wrapper-content animated fadeInRight">
    <div class="col-sm-12">
        ...
        <div id="toolbar">
            <button class="btn btn-primary" onclick="showRemoteAddModal('add-modal', '/user-sell/add-modal', 'add-form', validateFields())">
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu">
                <li>
                    <a href="javascript:void(0);" onclick="batchActive('/user-sell/batch-active', 0, 'data-list', '/user-sell/pager-cond', 'orderId')">
                        <i class="fa fa-check-square-o text-success"></i><span class="text-success">&nbsp;批量激活</span>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0);" onclick="batchActive('/user-sell/batch-active', 1, 'data-list', '/user-sell/pager-cond', 'orderId')">
                        <i class="fa fa-minus-square-o text-danger"></i><span class="text-danger">&nbsp;批量冻结</span>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0);" onclick="batchRemove('/user-sell/batch-remove', 'data-list', '/user-sell/pager-cond', 'orderId')">
...
<script src="<%=path%>/static/js/UserSellOrder/UserSellOrder.js"></script>
</html>
