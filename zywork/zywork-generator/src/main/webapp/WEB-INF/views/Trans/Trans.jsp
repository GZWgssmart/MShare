...
<div class="row wrapper wrapper-content animated fadeInRight">
    <div class="col-sm-12">
        ...
        <div id="toolbar">
            <button class="btn btn-primary" onclick="showRemoteAddModal('add-modal', '/trans/add-modal', 'add-form', validateFields())">
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu">
                <li>
                    <a href="javascript:void(0);" onclick="batchActive('/trans/batch-active', 0, 'data-list', '/trans/pager-cond', 'id')">
                        <i class="fa fa-check-square-o text-success"></i><span class="text-success">&nbsp;批量激活</span>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0);" onclick="batchActive('/trans/batch-active', 1, 'data-list', '/trans/pager-cond', 'id')">
                        <i class="fa fa-minus-square-o text-danger"></i><span class="text-danger">&nbsp;批量冻结</span>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0);" onclick="batchRemove('/trans/batch-remove', 'data-list', '/trans/pager-cond', 'id')">
...
<script src="<%=path%>/static/js/Trans/Trans.js"></script>
</html>
