...
<div class="modal-footer">
    ...
    <button id="btn-edit" type="button" class="btn btn-primary" onclick="saveOrEdit('btn-edit', 'edit-modal', 'edit-form', '/trans/update', 'data-list', '/trans/pager-cond')">确认</button>
</div>
