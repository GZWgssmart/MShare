...
<div class="modal-footer">
    ...
    <button id="btn-save" type="button" class="btn btn-primary" onclick="saveOrEdit('btn-save', 'add-modal', 'add-form', '/user-buy/save', 'data-list', '/user-buy/pager-cond')">确认</button>
</div>
