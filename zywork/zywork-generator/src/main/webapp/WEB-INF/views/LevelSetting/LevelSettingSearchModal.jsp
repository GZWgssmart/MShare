...
<div class="modal-body">
    <table id="level-setting-data-list" data-classes="table table-hover text-nowrap" data-toolbar="#level-setting-toolbar"></table>

    <div id="level-setting-toolbar">
        <button class="btn btn-primary" onclick="">
            <i class="fa fa-key"></i>
            确认
        </button>
        <button class="btn btn-primary" onclick="showSearchForm('level-setting-search-form')">
            <i class="fa fa-eye"></i>
            高级搜索
        </button>
        <button type="button" class="btn btn-white" data-dismiss="modal">取消</button>

        <form id="level-setting-search-form" class="row form-horizontal search-form" style="display: none;">
    ...
    <div class="input-group date form_datetime col-sm-8" style="padding-left: 15px; padding-right: 15px;">
        ...
        <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
            ...
            <div class="col-sm-6 form-group text-right" style="padding-right: 30px;">
                <button type="button" class="btn btn-primary" onclick="doSearch('level-setting-data-list')">
                    <i class="fa fa-search"></i>
                    搜索
                </button>
                <button type="button" class="btn btn-primary" onclick="doSearchAll('level-setting-data-list', 'level-setting-search-form')">
                    <i class="fa fa-search"></i>
                    搜索所有
                </button>
                <button type="button" class="btn btn-primary" onclick="hideSearchForm('level-setting-data-list', 'level-setting-search-form')">
