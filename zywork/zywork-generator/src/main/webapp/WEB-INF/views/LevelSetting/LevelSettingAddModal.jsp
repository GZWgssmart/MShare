...
<div class="modal-footer">
    ...
    <button id="btn-save" type="button" class="btn btn-primary" onclick="saveOrEdit('btn-save', 'add-modal', 'add-form', '/level-setting/save', 'data-list', '/level-setting/pager-cond')">确认</button>
</div>
