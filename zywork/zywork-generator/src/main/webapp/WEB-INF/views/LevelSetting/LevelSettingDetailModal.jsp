...
<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">等级名称：</span>
    <span class="col-sm-8" id=nameDetail></span>
</div>

<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">最小金额：</span>
    <span class="col-sm-8" id=minMoneyDetail></span>
</div>

<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">最大金额：</span>
    <span class="col-sm-8" id=maxMoneyDetail></span>
</div>

<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">转换比例：</span>
    <span class="col-sm-8" id=transPercentDetail></span>
</div>
