...
<div class="modal-body">
    ...
    <span class="col-sm-8" id="suggestIdDetail"></span>
</div>

<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">用户编号：</span>
    <span class="col-sm-8" id="suggestUserIdDetail"></span>
</div>

<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">投诉建议：</span>
    <span class="col-sm-8" id="suggestSuggestDetail"></span>
</div>

<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">创建时间：</span>
    <span class="col-sm-8" id="suggestCreateTimeDetail"></span>
</div>

<div class="col-sm-6 detail-content">
    <span class="col-sm-4 row-detail-title">更新时间：</span>
    <span class="col-sm-8" id="suggestUpdateTimeDetail"></span>
</div>
