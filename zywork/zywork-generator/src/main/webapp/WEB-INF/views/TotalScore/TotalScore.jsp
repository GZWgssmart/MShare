...
<div class="row wrapper wrapper-content animated fadeInRight">
    <div class="col-sm-12">
        ...
        <div id="toolbar">
            <button class="btn btn-primary" onclick="showRemoteAddModal('add-modal', '/total-score/add-modal', 'add-form', validateFields())">
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu">
                <li>
                    <a href="javascript:void(0);" onclick="batchActive('/total-score/batch-active', 0, 'data-list', '/total-score/pager-cond', 'id')">
                        <i class="fa fa-check-square-o text-success"></i><span class="text-success">&nbsp;批量激活</span>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0);" onclick="batchActive('/total-score/batch-active', 1, 'data-list', '/total-score/pager-cond', 'id')">
                        <i class="fa fa-minus-square-o text-danger"></i><span class="text-danger">&nbsp;批量冻结</span>
                    </a>
                </li>
                <li>
                    <a href="javascript:void(0);" onclick="batchRemove('/total-score/batch-remove', 'data-list', '/total-score/pager-cond', 'id')">
...
<script src="<%=path%>/static/js/TotalScore/TotalScore.js"></script>
</html>
