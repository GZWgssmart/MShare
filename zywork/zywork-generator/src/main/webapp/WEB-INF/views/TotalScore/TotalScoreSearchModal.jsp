...
<div class="modal-body">
    <table id="total-score-data-list" data-classes="table table-hover text-nowrap" data-toolbar="#total-score-toolbar"></table>

    <div id="total-score-toolbar">
        <button class="btn btn-primary" onclick="">
            <i class="fa fa-key"></i>
            确认
        </button>
        <button class="btn btn-primary" onclick="showSearchForm('total-score-search-form')">
            <i class="fa fa-eye"></i>
            高级搜索
        </button>
        <button type="button" class="btn btn-white" data-dismiss="modal">取消</button>

        <form id="total-score-search-form" class="row form-horizontal search-form" style="display: none;">
...
<div class="col-sm-6 form-group">
    <label for="totalSearch" class="col-sm-4 control-label">兑换数额：</label>
    <div class="col-sm-8">
        <input id="totalSearch" name="total" class="form-control" placeholder="请输入兑换数额">
    </div>
</div>

<div class="col-sm-6 form-group">
    <label for="scoreSearch" class="col-sm-4 control-label">兑换积分：</label>
    <div class="col-sm-8">
        <input id="scoreSearch" name="score" class="form-control" placeholder="请输入兑换积分">
    </div>
</div>
    ...
    <div class="input-group date form_datetime col-sm-8" style="padding-left: 15px; padding-right: 15px;">
        ...
        <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
            ...
            <div class="col-sm-6 form-group text-right" style="padding-right: 30px;">
                <button type="button" class="btn btn-primary" onclick="doSearch('total-score-data-list')">
                    <i class="fa fa-search"></i>
                    搜索
                </button>
                <button type="button" class="btn btn-primary" onclick="doSearchAll('total-score-data-list', 'total-score-search-form')">
                    <i class="fa fa-search"></i>
                    搜索所有
                </button>
                <button type="button" class="btn btn-primary" onclick="hideSearchForm('total-score-data-list', 'total-score-search-form')">
